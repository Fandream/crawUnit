    ...
    <el-row>
      <el-form label-width="150px"
        ...
        <el-form-item :label="'任务ID'">
          <el-input v-model="taskForm._id" placeholder="任务ID" disabled></el-input>
        </el-form-item>
        ...
        <el-form-item :label="'日志文件路径'">
          <el-input v-model="taskForm.log_path" placeholder="日志文件路径" disabled></el-input>
        </el-form-item>
        <el-form-item :label="'参数'">
          <el-input v-model="taskForm.param" placeholder="参数" disabled></el-input>
        </el-form-item>
        <el-form-item :label="'创建时间'">
          <el-input :value="getTime(taskForm.create_ts)" placeholder="创建时间" disabled></el-input>
        </el-form-item>
        <el-form-item :label="'开始时间'">
          <el-input :value="getTime(taskForm.start_ts)" placeholder="开始时间" disabled></el-input>
        </el-form-item>
        ...
        <el-form-item :label="'总时长(秒)'">
          <el-input :value="getTotalDuration(taskForm)" placeholder="总时长(秒)" disabled></el-input>
        </el-form-item>
        <el-form-item :label="'结果数'">
          <el-input v-model="taskForm.result_count" placeholder="结果数" disabled></el-input>
        </el-form-item>
