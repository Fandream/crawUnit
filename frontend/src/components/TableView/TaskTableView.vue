<template>
  <div class="task-table-view">
    ...
    >
      ...
      <el-table-column property="spider_name" :label="'爬虫'" width="120" align="left">
        <template slot-scope="scope">
      ...
      <el-table-column property="result_count" :label="'结果数'" width="60" align="right">
        <template slot-scope="scope">
      ...
      <el-table-column property="create_ts" :label="'创建时间'" width="150" align="left">
        <template slot-scope="scope">
