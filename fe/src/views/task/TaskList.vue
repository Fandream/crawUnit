        ...
        <div class="left">
          <el-form class="filter-form" :model="filter" label-width="100px" label-position="right" inline>
            <el-form-item prop="node_id" :label="'节点'">
              <el-select v-model="filter.node_id" size="small" :placeholder="'Node'" @change="onFilterChange">
                <el-option value="" :label="'全部'"/>
                <el-option v-for="node in nodeList" :key="node._id" :value="node._id" :label="node.name"/>
              </el-select>
            </el-form-item>
            <el-form-item prop="spider_id" :label="'爬虫'">
              <el-select v-model="filter.spider_id" size="small" :placeholder="'爬虫'" @change="onFilterChange"
            ...
            <el-form-item prop="status" :label="'状态'">
              <el-select v-model="filter.status" size="small" :placeholder="'状态'" @change="onFilterChange">
        ...
        <template v-for="col in columns">
          ...
          <el-table-column v-else-if="col.name === 'status'"
            ...
            <template slot-scope="scope">
              ...
              >
                <el-tooltip :content="'日志错误' + ': ' + scope.row.error_log_count" placement="top">
                  <el-tag
                    type="danger"
