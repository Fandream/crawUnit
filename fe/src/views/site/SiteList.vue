<template>
  <div class="app-container">
    ...
    <div class="filter">
      ...
      <el-select v-model="filter.mainCategory" class="filter-category" :placeholder="'Select Main Category'"
      ...
      <el-select v-model="filter.category" class="filter-category" :placeholder="'Select Category'"
    ...
    <el-table :data="siteList"
      ...
      <el-table-column :label="'Action'" align="left" width="120" v-if="false">
        <template slot-scope="scope">
