  ...
  <div class="app-container schedule-list">
    ...
    >
      ...
      >
        ...
        <el-form-item
          v-if="scheduleForm.run_type === 'selected-nodes'"
          :label="'节点'"
          prop="node_ids"
          required
        >
        ...
        >
          <el-select
            v-model="scheduleForm.scrapy_spider"
            :placeholder="'Scrapy 爬虫'"
            :disabled="isLoading"
          >
            <el-option
        ...
        >
          <el-select
            v-model="scheduleForm.scrapy_log_level"
            :placeholder="'Scrapy 日志等级'"
          >
    ...
    <el-card style="border-radius: 0" class="schedule-list">
      ...
      >
        <template v-for="col in columns">
          ...
          >
            <template slot-scope="scope">
              <template v-if="scope.row.run_type === 'all-nodes'">{{
                "All Nodes"
              }}</template>
              <template v-else-if="scope.row.run_type === 'selected-nodes'">{{
                "Selected Nodes"
              }}</template>
              <template v-else-if="scope.row.run_type === 'random'">{{
                "Random"
              }}</template>
            </template>
          </el-table-column>
