<template>
  <div class="file-list-container">
    <el-dialog
      ...
      width="30%">
      <el-form>
        <el-form-item :label="'输入新目录名称'">
          <el-input v-model="name" :placeholder="'新目录名称'"></el-input>
        </el-form-item>
      </el-form>
      <span slot="footer" class="dialog-footer">
        <el-button @click="dirDialogVisible = false">{{'取消'}}</el-button>
        <el-button type="primary" @click="onAddDir">{{'确认'}}</el-button>
      </span>
    </el-dialog>
    ...
    <el-dialog
      ...
      width="30%">
      <el-form>
        <el-form-item :label="'输入新文件名称'">
          <el-input v-model="name" :placeholder="'新文件名称'"></el-input>
        </el-form-item>
      </el-form>
      <span slot="footer" class="dialog-footer">
        <el-button size="small" @click="fileDialogVisible = false">{{'取消'}}</el-button>
        <el-button size="small" type="primary" @click="onAddFile">{{'确认'}}</el-button>
      </span>
    </el-dialog>
