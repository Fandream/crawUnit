            ...
            <ul class="list">
              ...
              <li class="item">
                ...
                <div class="selector-type">
                  <span
                    class="selector-type-item"
                    @click="onClickSelectorType('css')"
                  >
                    <el-tag
                  ...
                  <span
                    class="selector-type-item"
                    @click="onClickSelectorType('xpath')"
                  >
                    <el-tag
