    ...
    <el-tabs type="border-card">
      ...
      <el-tab-pane>
        ...
        <div class="tabBody">
          ...
          <el-row>
            <el-radio class="long" v-model="day.cronEvery" label="3"
      ...
      <el-tab-pane>
        <span slot="label"
          ><i class="el-icon-date"></i> {{ text.Week.name }}</span
        >
        <div class="tabBody">
          <el-row>
          ...
          <el-row>
            <el-radio class="long" v-model="week.cronEvery" label="3"
              >{{ text.Week.specific }}
...
export default {
  ...
  methods: {
    ...
    submit() {
      if (!this.validate()) {
        this.$message.error("Cron expression is invalid");
        return false;
      }
